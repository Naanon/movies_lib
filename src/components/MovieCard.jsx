...
export function MovieCard({ movie, showLink = true, width = "3/10" }) {
  return (
    <div className={`w-${width} text-white text-center mb-10 flex flex-col justify-between bg-black-400 p-4 rounded-xl`}>
      <img className="mb-4 max-w-full" src={imageUrl + movie.poster_path} alt={movie.title} />
